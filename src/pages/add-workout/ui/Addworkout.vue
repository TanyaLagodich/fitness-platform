...
import {
  AddExerciseModal,
  ExerciseList,
  useExerciseManagementStore,
} from '@/feature/exercise-management';
...
<template>
  <v-card v-if="clientStore.client">
    <v-card-text>
      <p>Назначить для:</p>
      <v-tooltip :text="clientStore.client.name" location="bottom">
      ...
      <v-row class="mt-4">
        ...
        <v-col cols="3">
          <v-date-input v-model="workout.date" label="Дата" />
        </v-col>
      </v-row>

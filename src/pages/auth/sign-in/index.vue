...
<template>
      ...
      <v-card class="pa-6" elevation="6" max-width="500" width="100%">
        ...
        <v-card-text>
          ...
          <v-text-field v-model="email" label="Email" type="email" variant="outlined" clearable required />
          <v-text-field v-model="password" label="Пароль" type="password" variant="outlined" clearable required />

...
const rules = {
  ...
  password: (v: string) =>
      v.length >= 6 || "Пароль должен быть минимум 6 символов",
  confirmPassword: (v: string) => (v.length && signUpModel.newCoach.password && v === signUpModel.newCoach.password) || 'Пароли не совпадают',
};
